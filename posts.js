const posts = [
  ...
  },
  {
    ...
    date: "2026-08-18",
    time: "16:30",
    text: "Мне тут посоветовали использовать сборщик фронтенда Vite и фреймворк NestJS для оптимизации и удобства. Скоро ограничением сайта станет моя фантазия, а не знания дипсика как раньше",
